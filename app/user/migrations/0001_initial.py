    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.departmentgroups')),
                ('department_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.departmentteams')),
                ('designation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.designation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited_fields', models.JSONField(blank=True, default=dict)),
                ('emp_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.employeestatus')),
                ('employee_draft', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.employeedraft')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.company')),
                ('department_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.departmentteams')),
                ('summaries_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='user.summarystatus')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_litre', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('vehicle_allowance', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.employee')),
                ('vehicle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.vehiclemodel')),
            ],
        ),
        migrations.CreateModel(
